...
# fetch the mac address from the dpid: datapath id, which is used to identify switches in openflow
def dpid_to_mac (dpid):
  return EthAddr("%012x" % (dpid & 0xffFFffFFffFF,))


class lab3_switch (EventMixin):
...
def launch (fakeways="", arp_for_unknowns=None):
  ...
  core.registerNew(lab3_switch, fakeways, arp_for_unknowns)
